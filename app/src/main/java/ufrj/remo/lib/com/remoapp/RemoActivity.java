...
public class RemoActivity extends AppCompatActivity {
    private float mAccelerationX, mAccelerationY, mAccelerationZ;
    String mAccelerationXString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccelerationTextView = (TextView) findViewById(R.id.accelerationTextView);
...
//        setSupportActionBar(toolbar);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_remo, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_remo, container, false);
 //           TextView textView = (TextView) rootView.findViewById(R.id.centerValueTextView);
  //          textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class AccelerometerSensorListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            mAccelerationX = (float) Math.sqrt(mAccelerationX*mAccelerationX + mAccelerationY*mAccelerationY + mAccelerationZ*mAccelerationZ);
            mAccelerationXString = Float.toString(mAccelerationX);
            if (mAccelerationXString.length() > 4)  mAccelerationXString = mAccelerationXString.substring(0, 4);
            if (mAccelerationTextView != null) {
                mAccelerationXString = "Aceleração: " + mAccelerationXString + "m/s²";
                mAccelerationTextView.setText(mAccelerationXString);
            }
        }
